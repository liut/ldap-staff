...
<html lang="en">
  <head>
    ...
    <title>Staff panel | change password</title>
  ...
  <div class="container">
    ...
    <form class="form-horizontal" id="form1" method="post" action="/password/change">
  ...
  <script src="/static/js/pwstrength-bootstrap-1.2.7.min.js"></script>
